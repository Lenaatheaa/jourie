...
import androidx.compose.foundation.lazy.LazyColumn // DIGANTI: Menggunakan LazyColumn, bukan Column biasa
...
fun MilestonesScreen(
    ...
    if (state.isLoading) {
        ...
        LazyColumn(
            ...
            contentPadding = PaddingValues(bottom = 24.dp), // Padding diatur di sini
            ...
            item {
                MilestoneCategoryGrid(title = "Streak", badges = state.streakBadges)
            }

            // Item 4: Grid Kategori Jurnal
            item {
                MilestoneCategoryGrid(title = "Journals", badges = state.journalBadges)
            }
