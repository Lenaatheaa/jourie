...
class GeminiAiRepository {
        ...
        suspend fun analyzeJournal(content: String): JournalAiResult {
                ...
                val prompt = buildString {
                        ...
                        appendLine("    \"Happy\": 0.15,")
                        appendLine("    \"Neutral\": 0.05,")
                        appendLine("    \"Anxious\": 0.20,")
                        appendLine("    \"Sad\": 0.10,")
                        appendLine("    \"Excited\": 0.08,")
                        appendLine("    \"Calm\": 0.12,")
                        appendLine("    \"Angry\": 0.05,")
                        appendLine("    \"Disappointed\": 0.03,")
                        appendLine("    \"Grateful\": 0.07,")
                        appendLine("    \"Tired\": 0.04,")
                        appendLine("    \"Confused\": 0.02,")
                        appendLine("    \"Loved\": 0.03,")
                        appendLine("    \"Scared\": 0.01,")
                        appendLine("    \"Joyful\": 0.02,")
                        appendLine("    \"Hopeless\": 0.01,")
                        appendLine("    \"Frustrated\": 0.01,")
                        appendLine("    \"Thoughtful\": 0.00,")
                        appendLine("    \"Overwhelmed\": 0.01")
                        appendLine("  }")
                        appendLine("}")
